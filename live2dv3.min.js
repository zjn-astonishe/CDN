(function () {
    ...
    class Live2dV3 { // eslint-disable-line no-unused-vars
      constructor ({ basePath, modelName, width = 500, height = 300, el, sizeLimit, mobileLimit, sounds }) {
        ...
        if (sizeLimit && (document.documentElement.clientWidth < window.screen.width / 2 || document.documentElement.clientHeight < window.screen.height / 2)) return
        ...
        window.onresize = (event) => {
          ...
          if (this.model) {
            ...
            this.model.scale = new PIXI.Point((this.model.position.x * 0.16), (this.model.position.x * 0.16))
